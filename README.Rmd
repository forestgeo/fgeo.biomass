...
The `rowid`s were generated from the row-names of your original census data. Now that you have a single row per `rowid`, you can add the equations to your census data with `dplyr::left_join()`.
...
Thus you can now calculate and summarize biomass in the context of your census data.
