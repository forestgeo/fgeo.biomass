...
* The output excludes equations that apply to only part of a tree -- instead of the whole tree (e.g. https://github.com/forestgeo/allodb/issues/63, https://github.com/forestgeo/fgeo.biomass/issues/9).
