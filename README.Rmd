...
* Simplify interfaces via generic functions that 'know' what to do with different (S3) classes of ForestGEO data -- i.e. census and scpecies tables; ViewFullTable and ViewTaxonomy talbles; or any two tables of unknown class.
