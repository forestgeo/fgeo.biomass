# Contributing to fgeo.biomass

This outlines how to propose a change to __fgeo.biomass__. For more detailed info about contributing to this, and other __fgeo.biomass__ packages, please see the [**development contributing guide of the tidyverse**](https://rstd.io/tidy-contrib) (wherever you read __tidyverse__ think __fgeo.biomass__).
...
See tidyverse [development contributing guide](https://rstd.io/tidy-contrib) for further details (wherever you read __tidyverse__ think __fgeo.biomass__).
